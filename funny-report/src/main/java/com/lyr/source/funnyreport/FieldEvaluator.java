...
import com.lyr.source.funnyreport.parser.FunnyReportBaseVisitor;
...
public class FieldEvaluator extends FunnyReportBaseVisitor<Object> {
    ...
    @Override
    public Object visitBracedExpression(FunnyReportParser.BracedExpressionContext ctx) {
        return visitExpression(ctx.expression());
    }

    @Override
    public Object visitExpression(FunnyReportParser.ExpressionContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitPrimary(FunnyReportParser.PrimaryContext ctx) {
        Object rtn = null;
        if (ctx.literal() != null) {
    ...
    @Override
    public Object visitLiteral(FunnyReportParser.LiteralContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitFloatLiteral(FunnyReportParser.FloatLiteralContext ctx) {
        return Float.valueOf(ctx.getText());
    }

    @Override
    public Object visitIntegerLiteral(FunnyReportParser.IntegerLiteralContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitFunctionCall(FunnyReportParser.FunctionCallContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitExpressionList(FunnyReportParser.ExpressionListContext ctx) {
        Object rtn = null;
        for (FunnyReportParser.ExpressionContext child : ctx.expression()) {
    ...
    // 求排序值（向量）
    private Object rank(FunnyReportParser.FunctionCallContext ctx) {
        Object rtn = null;
    ...
    // 求最大值（标量）
    private Object max(FunnyReportParser.FunctionCallContext ctx) {
        Object rtn = null;
        String functionFieldName = ctx.getText();
    ...
    // 求汇总值（标量）
    private Object sum(FunnyReportParser.FunctionCallContext ctx) {
        Object rtn = null;
        String functionFieldName = ctx.getText();
    ...
    // 求累计汇总值（向量）
    private Object runningSum(FunnyReportParser.FunctionCallContext ctx) {
        Object rtn = null;
        String functionFieldName = ctx.getText();
    ...
    // 根据公式，往数据源里添加一个计算字段
    private void addCalculatedField(FunnyReportParser.ExpressionContext ctx) {
