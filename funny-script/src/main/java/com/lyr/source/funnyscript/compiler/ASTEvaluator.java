...
public class ASTEvaluator extends FunnyScriptBaseVisitor<Object> {
    ...
    public LValue getLValue(Variable variable) {
        ...
        // 通过正常的作用域找不到，就从闭包里找
        // 原理：FunnyObject中可能有一些变量，其作用域跟StackFrame.scope是不同的。 // TODO：差异在哪来处理的？？
    ...
    public Object visitStatement(FunnyScriptParser.StatementContext ctx) {
        ...
        // for循环
            ...
            FunnyScriptParser.ForControlContext forControl = ctx.forControl();
    ...
    @Override
    public Object visitTypeType(FunnyScriptParser.TypeTypeContext ctx) {
        return visitPrimitiveType(ctx.primitiveType());
    }

    @Override
    public Object visitPrimitiveType(FunnyScriptParser.PrimitiveTypeContext ctx) {
        Object rtn = null;
        if (ctx.INT() != null) {
            rtn = FunnyScriptParser.INT;
        } else if (ctx.LONG() != null) {
            rtn = FunnyScriptParser.LONG;
        } else if (ctx.FLOAT() != null) {
            rtn = FunnyScriptParser.FLOAT;
        } else if (ctx.DOUBLE() != null) {
            rtn = FunnyScriptParser.DOUBLE;
        } else if (ctx.BOOLEAN() != null) {
            rtn = FunnyScriptParser.BOOLEAN;
        } else if (ctx.CHAR() != null) {
            rtn = FunnyScriptParser.CHAR;
        } else if (ctx.SHORT() != null) {
            rtn = FunnyScriptParser.SHORT;
        } else if (ctx.BYTE() != null) {
            rtn = FunnyScriptParser.BYTE;
        }
        return rtn;
    }

    @Override
    public Object visitBlock(FunnyScriptParser.BlockContext ctx) {
        BlockScope scope = (BlockScope) at.node2Scope.get(ctx);
        // 有些block是不对应scope的，比如函数底下的block.
        if (scope != null) {
            StackFrame frame = new StackFrame(scope);
            pushStack(frame);
        }
    ...
    @Override
    public Object visitExpressionList(FunnyScriptParser.ExpressionListContext ctx) {
        Object rtn = null;
        for (FunnyScriptParser.ExpressionContext child : ctx.expression()) {
    ...
    @Override
    public Object visitForInit(FunnyScriptParser.ForInitContext ctx) {
        Object rtn = null;
        if (ctx.variableDeclarators() != null) {
            rtn = visitVariableDeclarators(ctx.variableDeclarators());
    ...
    @Override
    public Object visitParExpression(FunnyScriptParser.ParExpressionContext ctx) {
    ...
    @Override
    public Object visitPrimary(FunnyScriptParser.PrimaryContext ctx) {
        Object rtn = null;
        // 字面量
        if (ctx.literal() != null) {
    ...
    @Override
    public Object visitLiteral(FunnyScriptParser.LiteralContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitIntegerLiteral(FunnyScriptParser.IntegerLiteralContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitFloatLiteral(FunnyScriptParser.FloatLiteralContext ctx) {
        return Float.valueOf(ctx.getText());
    }

    @Override
    public Object visitExpression(FunnyScriptParser.ExpressionContext ctx) {
        Object rtn = null;
        ...
        } else if (ctx.bop != null && ctx.bop.getType() == FunnyScriptParser.DOT) {
            // 此语法是左递归的，算法体现这一点
    ...
    @Override
    public Object visitFunctionCall(FunnyScriptParser.FunctionCallContext ctx) {
        // this
        if (ctx.THIS() != null) {
            thisConstructor(ctx);
        ...
        if (symbol instanceof DefaultConstructor) {
            // 类的缺省构造函数。没有一个具体函数跟它关联，只是指向了一个类。 // 返回新创建的对象
    ...
    @Override
    public Object visitClassBody(FunnyScriptParser.ClassBodyContext ctx) {
        Object rtn = null;
        for (FunnyScriptParser.ClassBodyDeclarationContext child : ctx.classBodyDeclaration()) {
    ...
    @Override
    public Object visitClassBodyDeclaration(FunnyScriptParser.ClassBodyDeclarationContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitMemberDeclaration(FunnyScriptParser.MemberDeclarationContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitFieldDeclaration(FunnyScriptParser.FieldDeclarationContext ctx) {
        Object rtn = null;
        if (ctx.variableDeclarators() != null) {
            rtn = visitVariableDeclarators(ctx.variableDeclarators());
        }
    ...
    @Override
    public Object visitFunctionDeclaration(FunnyScriptParser.FunctionDeclarationContext ctx) {
        return visitFunctionBody(ctx.functionBody());
    }

    @Override
    public Object visitFunctionBody(FunnyScriptParser.FunctionBodyContext ctx) {
        Object rtn = null;
        if (ctx.block() != null) {
    ...
    protected void defaultObjectInit(Class theClass, ClassObject obj) {
        ...
        // 执行缺省初始化
        FunnyScriptParser.ClassBodyContext ctx = ((FunnyScriptParser.ClassDeclarationContext) theClass.ctx).classBody();
        visitClassBody(ctx);
    ...
    private void thisConstructor(FunnyScriptParser.FunctionCallContext ctx) {
        Symbol symbol = at.symbolOfNode.get(ctx);
        // 缺省构造函数
        if (symbol instanceof DefaultConstructor) {
    ...
    // 自己硬编码的println方法
    private void println(FunnyScriptParser.FunctionCallContext ctx) {
     ...
     */
    private void getClosureValues(Function function, FunnyObject valueContainer) {
    ...
    private void getClosureValues(ClassObject classObject) {
        ...
        FunnyObject tempObject = new FunnyObject();
     ...
     * @return
     */
    private Object methodCall(ClassObject classObject, FunnyScriptParser.FunctionCallContext ctx, boolean isSuper) {
        Object rtn;
    ...
    private Object functionCall(FunctionObject functionObject, List<Object> paramValues) {
        ...
        FunnyScriptParser.FunctionDeclarationContext functionCode = (FunnyScriptParser.FunctionDeclarationContext) functionObject.function.ctx;
        if (functionCode.formalParameters().formalParameterList() != null) {
            for (int i = 0; i < functionCode.formalParameters().formalParameterList().formalParameter().size(); i++) {
                FunnyScriptParser.FormalParameterContext param = functionCode.formalParameters().formalParameterList().formalParameter(i);
     ...
     * @return
     */
    private List<Object> calcParamValues(FunnyScriptParser.FunctionCallContext ctx) {
     ...
     * @return
     */
    private FunctionObject getFunctionObject(FunnyScriptParser.FunctionCallContext ctx) {
        // 暂时不支持this和super
